...
const places = [
  {
    ...
    rating: 4,
    address: 'Jl. Raya Banjarejo No.245, Banjarsari, Banjarejo, Kec. Pakis, Kabupaten Malang, Jawa Timur 65154'
  },
  {
    id: '2',
  ...
  },
  {
    ...
    rating: 3,
    address: '2M72+C77, Lesanpuro, Kec. Kedungkandang, Kota Malang, Jawa Timur 65137'
  },
  {
    id: '6',
    ...
    rating: 5,
    address: '3M29+Q6M, Krajan, Mangliawan, Kec. Pakis, Kabupaten Malang, Jawa Timur 65154'
  },
];
...
export default function RecommendationPlaceScreen() {
  ...
  const renderItem = ({ item }: { item: any }) => (
    <TouchableOpacity
      ...
      onPress={() => router.push('/Information_Place')}
    >
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.searchContainer}>
          <Text style={styles.placeholderText}>Tempat mancing terdekat</Text>
