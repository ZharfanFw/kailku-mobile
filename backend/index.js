...
// Tempat: Data Lokasi Mancing -> /spots/...
fastify.register(require("./routes/spot"), { prefix: "/spots" });
...
// Lomba: Data Lomba Mancing -> /lomba/...
fastify.register(require("./routes/lomba"), { prefix: "/lomba" });
